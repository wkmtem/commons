...
public class MD5 {
	...
	/**
	 * 
	 * <p>Method Name: getMD5</p>
	 * <p>Description: 获取MD5值</p>
	 * @author wkm
	 * @date 2017年8月17日下午6:39:15
	 * @version 2.0
	 * @param source
	 * @return
	 */
	 ...
	 */
	public String get2MD5StrByTimeMillis() {
		return this.getMD5(this.getMD5(System.currentTimeMillis() + ""));
	}
	 ...
	 * @return String code 32bit
	 */
	public String get2MD5StrBySaltWithPwd(String salt, String pwd) {
		return this.getMD5(this.getMD5(salt + pwd));
	}
